...
LOCAL_APPS = ['core_apps.common', 'core_apps.user_auth', 'core_apps.user_profile', 'core_apps.accounts', \
              'core_apps.cards']
...
DEFAULT_COUNTRY = 'EG'
DEFAULT_PHONE_NUMBER = '+201078412345'
...
SPECTACULAR_SETTINGS = {
    ...
    'DESCRIPTION': 'A simple banking API with authentication and transactions.',
    'VERSION': '1.0.0',
...
COOKIE_SECURE = getenv('COOKIE_SECURE', 'True').lower() == 'true'
...
LOGGING = {
    ...
    'handlers': {
        'loguru': {
            'level': 'DEBUG',
            'class': 'api.interceptor.InterceptHandler',
        },
    },
    'root': {
        'handlers': ['loguru'],
